...
class MushroomsNumpyDataModule:
    ...
    def __init__(self, data_dir: str = os.getenv("LIBSVM_DIR"), batch_size: int = 8):
        ...
        self.dataset = 'mushrooms'
        self.batch_size: int = batch_size
        self.num_samples: int = 8_124
        ...
        train_data, val_data, train_target, val_target = sklearn.model_selection.train_test_split(data, target, test_size=0.2, random_state=0)
...
def run_experiment(config):
    ...
    datamodule = MushroomsNumpyDataModule(batch_size=config['batch_size'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lmd', type=float, default=0.0, help="Regularization parameter. Default is 0.0.")
